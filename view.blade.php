    ...
    <body>
        <div class="container-fluid" >
            <nav class="navbar navbar-expand-sm ">
                <a class="navbar-brand" href="main.html"><img src="logo.png" height=100 width=100 alt=""></a>
        ...
        <div class="container">
            <div class="row">
                <button class="btn btn-primary btn-lg btn-block" onclick="location.href='/addProduct'">ADD</button>
                {{-- <h1>{{$gender}}</h1> 
                <h1>{{$category}}</h1> --}}
            </div>
        </div>

    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-2">
                    <button class="btn btn-outline-secondary btn-lg">FeMale Shirts</button>
                </div>
                <div class="col-2">
                    <button class="btn btn-outline-secondary btn-lg" onclick="location.href='view/{{"male"}}/{{"pant"}}'">Male Pants</button>
                </div>
                <div class="col-2">
                    <button class="btn btn-outline-secondary btn-lg">FeMale Pants</button>
                </div>
                <div class="col-2">
                    <button class="btn btn-outline-secondary btn-lg">Shoes</button>
                </div>
